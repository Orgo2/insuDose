...
void UART_DMA_Transmit(int32_t* trigger, uint16_t size)
{
    ...
    if (HAL_UART_Transmit_DMA(&huart1, (uint8_t*)trigger, size * sizeof(int32_t)) != HAL_OK)
    {
