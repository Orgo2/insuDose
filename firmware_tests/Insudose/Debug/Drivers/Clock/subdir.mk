...
Drivers/Clock/%.o Drivers/Clock/%.su Drivers/Clock/%.cyclo: ../Drivers/Clock/%.c Drivers/Clock/subdir.mk
...
clean-Drivers-2f-Clock:
	-$(RM) ./Drivers/Clock/clock.cyclo ./Drivers/Clock/clock.d ./Drivers/Clock/clock.o ./Drivers/Clock/clock.su
